...
const EventForm = ({ userId, event, eventId, type }: EventFormProps) => {
    ...
    const initialValues = event && type === "Ažuriraj" 
        ? { ...event, 
    ...
    return (
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <div className="flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                            ...
                            />
                            <p className="ml-3 whitespace-nowrap text-gray-600">Datum početka: </p>
                            <DatePicker 
                    ...
                    <FormControl>
                        <div className="flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                            <Image 
                                ...
                                className="filter-grey"
                            />
                            <p className="ml-3 whitespace-nowrap text-gray-600">Datum završetka: </p>
                            <DatePicker 
                            selected={field.value}
                            onChange={(date: Date | null) => field.onChange(date)}
                            showTimeSelect
            ...
            <Button
                ...
                className="button col-span-2 w-full bg-[#395E6F] hover:bg-[#4b6977]"
            >
